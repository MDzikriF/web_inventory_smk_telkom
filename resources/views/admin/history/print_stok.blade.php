...
<head>
    ...
    <title>Laporan Keluar Masuk Stok - {{ $bulanNama }} {{ $tahun }}</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="report-title">
        <h3>LAPORAN KELUAR MASUK STOK</h3>
        <p>Periode: {{ $bulanNama }} {{ $tahun }}</p>
    </div>

    <div class="section-title">Daftar Transaksi Stok</div>
    @if($transactions->isEmpty())
        <p style="text-align: center; font-style: italic;">Tidak ada transaksi keluar/masuk stok pada periode ini.</p>
    @else
        <table>
            <thead>
                <tr>
