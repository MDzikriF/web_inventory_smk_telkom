...
<head>
    ...
    <title>Laporan Peminjaman Aset - {{ $bulanNama }} {{ $tahun }}</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="section-title">Daftar Peminjaman Aset</div>
    @if($peminjaman->isEmpty())
        <p style="text-align: center; font-style: italic;">Tidak ada data peminjaman aset pada periode ini.</p>
    @else
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->kategori }}</td>
                    <td style="text-align: center;">{{ $item->jumlah_dipinjam }} {{ $item->satuan }}</td>
                    <td>{{ $item->peminjam }}</td>
