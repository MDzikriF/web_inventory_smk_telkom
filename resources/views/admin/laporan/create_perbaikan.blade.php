    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.laporan.store_perbaikan') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="jumlah_rusak">Jumlah Diperbaiki</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tanggal_lapor">Tanggal Perbaikan</label>
                                    <input type="date" class="form-control" id="tanggal_lapor" name="tanggal_lapor" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="kerusakan">Deskripsi Perbaikan</label>
